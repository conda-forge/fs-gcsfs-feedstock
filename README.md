...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fs-gcsfs-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3888&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fs-gcsfs-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fs-gcsfs` can be installed with `conda`:
...
```
mamba install fs-gcsfs
```

It is possible to list all of the versions of `fs-gcsfs` available on your platform with `conda`:
...
```
mamba search fs-gcsfs --channel conda-forge
```
...
mamba repoquery search fs-gcsfs --channel conda-forge

# List packages depending on `fs-gcsfs`:
mamba repoquery whoneeds fs-gcsfs --channel conda-forge

# List dependencies of `fs-gcsfs`:
mamba repoquery depends fs-gcsfs --channel conda-forge
```
